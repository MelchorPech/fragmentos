package com.example.m_p_g.fragmentos;
...
/*
        ...
        //Programación botón seleccion check
        btnCheck.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                FragmentManager fragmentManager = getSupportFragmentManager();
                DialogoSeleccionCheck dialogoCheck = new DialogoSeleccionCheck();
                dialogoCheck.show(fragmentManager, "tagSeleccion");
            }
        });
        //Programación botón seleccion radio
        btnRadio.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                FragmentManager fragmentManager = getSupportFragmentManager();
                DialogoSeleccionRadio dialogoRadio = new DialogoSeleccionRadio();
                dialogoRadio.show(fragmentManager, "tagSeleccion");
            }
        });
        */
    }
